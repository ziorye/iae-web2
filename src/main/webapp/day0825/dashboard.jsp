                ...
                <ul class="navbar-nav ml-auto d-flex align-items-lg-center">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <c:if test="${'admin@example.com'.equals(user.email)}">
                                <a class="dropdown-item" href="day0825/backend/dashboard.jsp">
                                    后台管理
                                </a>
                            </c:if>
...
<div class="container user-center" id="main_content">
    <div class="row">
        <div class="col-lg-3">
            <div class="card shadow-sm">
                <div class="card-body">
                    <div class="text-center">
                        <img src="img/default-avatar.png" class="img-fluid rounded-circle avatar shadow-sm">
                        <p class="text-muted font-size-14 mt-2 mb-2rem">${user.name}</p>
                    </div>
