package day0912.mapper;

import day0912.mybatis.mapper.PostMapper;
...
public class PostMapperTest {
    ...
    void testSqlStatementWithSpecialTag() {
        try (SqlSession sqlSession = sqlSessionFactory.openSession(true)) {
            List<Object> objects = sqlSession.selectList("day0912.mybatis.mapper.PostMapper.sqlStatementWithSpecialTag");
