...
<header>
    <nav class="navbar navbar-expand-lg navbar-light navbar-site mb-2rem">
        <div class="container">
            <a class="navbar-brand" href="webapp-demo" title="example">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto d-flex align-items-lg-center">
                    <li class="nav-item">
                        <a class="nav-link d-flex align-items-center " href="webapp-demo#">
    ...
    <div class="site-info text-center" id="site_info">
        <h1 class="site-title animate__animated animate__swing animate__delay-4s">网站标题</h1>
